    ...
    body = (
      <>
        ...
        <div className='Home-header'>
          ...
          {/* body */}
          <div className='Body_BlogDetails'>
            <div className='Body_BlogDetails-container'>
              <div>
                <h4 className='Body_BlogDetails-title'>{Title1}</h4>
                <img className='Body_BlogDetails-container_Img_CT' src={`https://drive.google.com/uc?export=view&id=${Icon}`} alt=''></img>
              </div>
              <div className='Body_BlogDetails-container-text'>
                {parse(Content)}
              </div>
            </div>
          </div>
