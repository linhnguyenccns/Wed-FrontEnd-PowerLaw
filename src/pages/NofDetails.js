    ...
    body = (
      <>
        ...
        <div className='Home-header'>
          ...
          {/* body */}
          <div className='Body_NofDetails'>
            <div className='Body_NofDetails-container'>
              <div>
                <h4 className='Body_NofDetails-title'>{Title1}</h4>
                <img className='Body_NofDetails-container_Img_CT' src={`https://drive.google.com/uc?export=view&id=${Icon}`} alt=''></img>
              </div>
              <div className='Body_NofDetails-container-text'>
                {parse(Content)}
              </div>
            </div>
          </div>
